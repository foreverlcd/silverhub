        ...
        <div className="section-container">
          ...
          <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="flex gap-4 animate-fade-in animation-delay-200">
               <Button size="lg" className="rounded-xl h-14 px-8 font-bold shadow-lg" onClick={() => navigate('/matching')}>
                 Reservar Coach
               </Button>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="bg-card rounded-[2.5rem] p-10 md:p-14 border border-border shadow-md relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                    <div>
                      <div className="inline-flex items-center gap-2 px-3 py-1 bg-accent/10 text-accent text-[10px] font-bold uppercase tracking-widest rounded-full mb-3 border border-accent/20">
                        Ruta de Maestría
                      </div>
                      <h2 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight">Ruta de Evolución IA</h2>
                    </div>
                    <div className="bg-primary/5 p-4 rounded-xl border border-primary/10 text-center min-w-[140px]">
                       <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1">Nivel Actual</p>
                       <p className="text-2xl font-bold text-primary">Silver Hub</p>
                    </div>
                  </div>
                  ...
                  <div className="relative space-y-12">
                    ...
                    {[
                      ...
                      <div key={i} className="flex gap-8 relative group/step">
                        <div className={cn(
                          "h-12 w-12 rounded-2xl flex items-center justify-center shrink-0 z-10 transition-all duration-500 shadow-md",
                          step.status === 'completed' ? "bg-success text-success-foreground" :
                          step.status === 'current' ? "bg-primary text-primary-foreground scale-110 shadow-primary/20" :
                          "bg-secondary/10 text-muted-foreground border border-border"
                        )}>
                          <step.icon className="h-6 w-6" />
                        </div>
                        <div className="flex-1 pb-2">
                           <div className="flex items-center justify-between mb-2">
                              <h4 className={cn("text-xl font-bold", step.status === 'upcoming' ? "text-muted-foreground" : "text-foreground")}>
                                {step.title}
                              </h4>
                  ...
                  <div className="mt-16 p-8 bg-primary rounded-2xl text-primary-foreground flex flex-col md:flex-row items-center gap-8 shadow-xl relative overflow-hidden">
                    ...
                    <div className="text-center md:text-left relative z-10">
                       <p className="text-xl font-bold mb-1">Próximo Salto: Analítica Predictiva</p>
                       <p className="text-sm opacity-80 font-medium">Tu Coach te espera el 24 de Enero para desbloquear esta competencia.</p>
                    </div>
                    <Button className="md:ml-auto bg-white text-primary hover:bg-white/90 rounded-xl h-14 px-8 font-bold text-xs shadow-md transition-all">
                       Ver Detalles
                    </Button>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <h2 className="text-2xl font-bold text-foreground">Tu Coach Ideal para hoy</h2>
                ...
                <div className="bg-primary/5 rounded-[2.5rem] p-1 border border-primary/10">
                   <MentorCard
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="grid grid-cols-1 gap-6">
                <div className="bg-card rounded-2xl p-8 border border-border shadow-md flex items-center gap-6">
                  <div className="h-16 w-16 rounded-2xl bg-primary/10 flex items-center justify-center text-primary">
                    <Calendar className="h-8 w-8" />
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-foreground tracking-tight">{completedSessions.length}</p>
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-widest">Próximo Encuentro</h3>
                {upcomingSessions.length > 0 ? (
                  ...
                  <div className="bg-card rounded-2xl p-10 text-center border-dashed border-2 border-border">
                    ...
                    <Button variant="outline" className="w-full h-12 rounded-xl font-bold border-primary/20" onClick={() => navigate('/matching')}>
                      Agendar Sesión
                    </Button>
                  </div>
                )}
              ...
              {/* Resources Box */}
              <div className="bg-primary rounded-[2.5rem] p-10 text-primary-foreground relative overflow-hidden shadow-xl">
                 <div className="absolute top-0 right-0 p-8 opacity-10">
                    <Sparkles className="w-24 h-24" />
                 </div>
                 <h3 className="text-xl font-bold mb-4">Centro de Recursos</h3>
                 <p className="text-sm font-medium opacity-80 mb-8 leading-relaxed">Accede a las últimas guías de IA Generativa para ejecutivos senior.</p>
                  <Button className="w-full bg-white text-primary hover:bg-white/90 rounded-xl h-12 font-bold shadow-md">
                    Explorar Biblioteca
                  </Button>
              </div>
            </div>
